...
def blrPredict(W, data):
    ...
    P = sigmoid(np.dot(data, W)) #posterior probability

    label = np.argmax(P,axis = 1)   #max for classes
...
train_label1 = train_label.ravel()
validation_label1 = validation_label.ravel()
test_label1 = test_label.ravel()
print('\n\n--------------SVM-------------------\n\n')
##################
# YOUR CODE HERE #
##################
